...
export const SCHEMA: Schema<typeof ELEMENTS, typeof SETTINGS> = {
  ...
  elements: [
    ...
    },
    {
      ...
      allowedTypes: ['Block'],
      settings: [
        SCHEMA_SETTINGS.mode,
        SCHEMA_SETTINGS.source,
        SCHEMA_SETTINGS.updated,
        SCHEMA_SETTINGS.domain,
        SCHEMA_SETTINGS.type,
        SCHEMA_SETTINGS.categories,
        SCHEMA_SETTINGS.category,
        SCHEMA_SETTINGS.scroll,
        SCHEMA_SETTINGS.display,
        SCHEMA_SETTINGS.expires,
        SCHEMA_SETTINGS.endpoint,
        SCHEMA_SETTINGS.placeholder,
        SCHEMA_SETTINGS.src,
      ],
    },
    {
