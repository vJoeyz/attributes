...
fixture`Field Element - Element - Not found errors`
  .page`http://localhost:3000/packages/support/public/scenarios/errors/field-element-element-applied-to.html`;
...
test('Field Element - Element - Not found', async (t) => {
  ...
  await assertErrorIsOnReport('field-element-field-field-1-value', 'applied-to', 1);
  await assertErrorIsOnAttribute('field-element-field-field-1-value', 'applied-to', 1);

  await writeFileValidationMessage('Field element type not entered', 'field-element-field-field-1-value');
});
