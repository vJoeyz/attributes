...
const attributesData: AttributesData = [
  ...
  {
    key: COMBO_BOX_ATTRIBUTE,
    title: 'Combobox',
    description: 'Select an item from a large list of options by searching using an input field.',
    href: createDocsHref('combobox'),
    baseSrc: `https://cdn.jsdelivr.net/npm/@finsweet/attributes-${COMBO_BOX_ATTRIBUTE}@1`,
    scriptSrc: `${COMBO_BOX_ATTRIBUTE}.js`,
    examplesSrc: 'examples.json',
    loadMode: 'defer',
    schemaSrc: 'schema.json',
    changesetsSrc: 'changesets.json',
